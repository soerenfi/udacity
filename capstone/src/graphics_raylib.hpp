        ...
        while (!raylib::WindowShouldClose()) {
            ...
            for (auto road : roads_) {
                ...
                for (auto pt : road.points_)
                    for (int line = 0; line < road.points_.size() - 1; line++) {
                        start = {road.points_[line].x_, road.points_[line].y_, road.points_[line].z_};
                        // raylib::Vector3 end{road.points_[line + 1].x_, road.points_[line + 1].y_,
                        //                     road.points_[line + 1].z_};
                        // raylib::DrawLine3D(start, end, raylib::BLUE);
                        raylib::DrawPoint3D(
                            raylib::Vector3{road.points_[line].x_, road.points_[line].y_, road.points_[line].z_},
                            raylib::BLUE);
                        linectr++;
                    }
            }
